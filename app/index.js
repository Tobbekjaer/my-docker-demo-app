(async function init() {
    ...
    document.getElementById('name').textContent = user.name ? user.name : 'Tobias Kjær';
    document.getElementById('email').textContent = user.email ? user.email : 'tobias.kjaer@example.com';
